...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.Platform.Android.OpenGLViewRenderer+Renderer, Xamarin.Forms.Platform.Android, Version=1.4.0.0, Culture=neutral, PublicKeyToken=null", OpenGLViewRenderer_Renderer.class, __md_methods);
	}
	...
	public OpenGLViewRenderer_Renderer ()
	{
		...
		if (getClass () == OpenGLViewRenderer_Renderer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.Platform.Android.OpenGLViewRenderer+Renderer, Xamarin.Forms.Platform.Android, Version=1.4.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
