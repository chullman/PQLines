...
{
    public class ConductorsViewModel : INavigationViewModel
    {
        private readonly IList<string> _buttonTextsParentIDs = new List<string>();
        private readonly CondContent _deserializedContents;
        ...
        public ConductorsViewModel(IRootModel deserializedContents, IViewModelNavigator viewModelNavigator,
            IList<IContentViewModel> viewModelsICanNavigateTo)
        {
            _deserializedContents = deserializedContents as CondContent;
            ...
            {
                foreach (var conductor in _deserializedContents.Conductors)
                {
        ...
        {
            if (_deserializedContents.Conductors.Count != 0)
            {
                return _deserializedContents.Conductors.Count;
            }
