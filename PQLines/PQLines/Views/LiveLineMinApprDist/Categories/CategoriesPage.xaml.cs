...
namespace PQLines.Views.LiveLineMinApprDist.Categories
{
    public partial class CategoriesPage : ThemedContentPage//, IPageContentBuilder
    {
        public CategoriesPage(IContentViewModel vmContext)
        {
            InitializeComponent();

            BindingContext = vmContext;

            XamlBindedScrollView.Content = CreateGridOfButtons(vmContext as CategoriesViewModel);
        }
        ...
        private RowDefinitionCollection CreateRowDefinitions(CategoriesViewModel vmContext)
        {
        ...
        private ColumnDefinitionCollection CreateColumnDefinitions(CategoriesViewModel vmContext)
        {
