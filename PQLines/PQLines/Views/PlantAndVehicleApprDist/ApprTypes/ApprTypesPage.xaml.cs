...
namespace PQLines.Views.PlantAndVehicleApprDist.ApprTypes
{
    public partial class ApprTypesPage : ThemedContentPage//, IPageContentBuilder
    {
        public ApprTypesPage(IContentViewModel vmContext)
        {
            InitializeComponent();

            BindingContext = vmContext;

            XamlBindedScrollView.Content = CreateGridOfButtons(vmContext as ApprTypesViewModel);
        }
        ...
        private Grid CreateGridOfButtons(ApprTypesViewModel vmContext)
        {
        ...
        private RowDefinitionCollection CreateRowDefinitions(ApprTypesViewModel vmContext)
        {
        ...
        private ColumnDefinitionCollection CreateColumnDefinitions(ApprTypesViewModel vmContext)
        {
