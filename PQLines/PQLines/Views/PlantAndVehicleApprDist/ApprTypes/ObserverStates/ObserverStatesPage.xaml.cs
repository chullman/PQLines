...
namespace PQLines.Views.PlantAndVehicleApprDist.ApprTypes.ObserverStates
{
    public partial class ObserverStatesPage : ThemedContentPage//, IPageContentBuilder
    {
        public ObserverStatesPage(IContentViewModel vmContext)
        {
            InitializeComponent();

            BindingContext = vmContext;

            XamlBindedScrollView.Content = CreateGridOfButtons(vmContext as ObserverStatesViewModel);
        }
        ...
        private Grid CreateGridOfButtons(ObserverStatesViewModel vmContext)
        {
        ...
        private RowDefinitionCollection CreateRowDefinitions(ObserverStatesViewModel vmContext)
        {
        ...
        private ColumnDefinitionCollection CreateColumnDefinitions(ObserverStatesViewModel vmContext)
        {
