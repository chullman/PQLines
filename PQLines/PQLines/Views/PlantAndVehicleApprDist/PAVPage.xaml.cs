...
namespace PQLines.Views.PlantAndVehicleApprDist
{
    public partial class PAVPage : ThemedContentPage//, IPageContentBuilder
    {
        public PAVPage(IContentViewModel vmContext)
        {
            InitializeComponent();

            BindingContext = vmContext;

            XamlBindedScrollView.Content = CreateGridOfButtons(vmContext as PAVViewModel);
        }
